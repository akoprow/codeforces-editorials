{% include exercise.md name="Perform Easily" id="1435C" also-as="1434A" labels="`brute force` `data structures` `dp` `sortings` `two pointers`" rating=1900 code="r660-679/r679/1434-Ia-perform-easily.kt" %}
