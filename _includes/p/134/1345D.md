{% include exercise.md name="Monopole Magnets" id="1345D" also-as="1344B" labels="`constructive algorithms` `dfs and similar` `dsu`" rating=2000 code="r620-639/r639/1345d-monopole-magnets.kt" %}
