{% include exercise.md name="Different Divisors" id="1474B" labels="constructive algorithms, greedy, math, number theory" code="r680-699/r696/1474b-different-divisors.kt" %}
