{% include exercise.md name="Non-Substring Subsequence" id="1451B" labels="`dp` `greedy` `implementation` `strings`" rating=900 code="r680-699/r685/1451b-non-substring-subsequence.kt" %}
