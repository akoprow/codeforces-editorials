{% include exercise.md name="Bitwise Queries (Easy Version)" id="1451E1" labels="`bitmasks` `constructive algorithms` `interactive` `math`" rating=2000 code="r680-699/r685/1451e1-bitwise-queries-easy.kt" %}
