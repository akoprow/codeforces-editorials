{% include exercise.md name="Divide and Summarize" id="1461D" labels="`divide and conquer` `implementation` `sortings`" code="r680-699/r689/1461d-divide-and-summarize.kt" %}
