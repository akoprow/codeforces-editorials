{% include exercise.md name="Eugene and an array" id="1333C" labels="binary search, data structures, implementation, two pointers" rating=1700 code="r620-639/r632/1333c-eugene-and-an-array.kt" %}
