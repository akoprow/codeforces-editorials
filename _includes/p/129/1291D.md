{% include exercise.md name="Irreducible Anagrams" id="1291D" also-as="1290B" labels="`binary search` `constructive algorithms` `data structures` `strings` `two pointers`" rating=1800
